<p align = "center">    
<img  src="./fig/sampleDistribution.png" width=55% />
</p>
...
We also visualize the data distribution of the sample and the population in Fig.1 and Fig.2. From these figures, we can not observe a significant difference in their distributions, concerning the length of reviews or the length of reviewed source code. It further confirms the representativeness of the sample. 


<p align = "center">    
<img  src="./fig/reviewLen.png" width=35% />
</p>

<p align = "center">    
<img  src="./fig/codeLine.png" width=35% />
</p>
